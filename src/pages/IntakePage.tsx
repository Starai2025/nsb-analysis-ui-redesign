      ...
      <div className="grid grid-cols-[minmax(0,1fr)_324px] gap-6">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-start gap-4 rounded-2xl bg-on-surface p-6 text-white shadow-xl shadow-slate-900/10 xl:p-7">
            ...
            <div>
              <p className="mb-1.5 text-[14px] font-bold">AI-Assisted Contract Analysis</p>
              <p className="text-[12px] font-medium leading-relaxed text-white/70">
                Your workspace stays browser-first. Documents are staged locally, then analyzed securely to generate the executive summary, evidence map, report, and draft.
              </p>
            </div>
          </div>
        </div>
